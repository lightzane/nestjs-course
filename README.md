## Modified NestJs In Practice Course

### Load with sample mongodb data

It is a prerequisite that you have a MongoDb with sample data.<br>
https://github.com/lightzane/mongodb-sample-data

### Getting Started

1. Use branch `1-start` to start
2. `npm install`
3. Create an entire seperate project / folder
4. `npm install -g @nestjs/cli`
5. `nest new project-name`

<strong>IMPORTANT:</strong> The branch `1-start` is just the frontend.<br>
So you will focus on learning [NestJs](https://nestjs.com/) which is the backend.
...
Refer to the sample data in MongoDb and the UI frontend to determine the BODY/query. <br>
Or refer to the `rest-api` folder in the branch `master`

```
## Courses
POST /api/courses
GET /api/courses
GET /api/courses/{courseUrl}
